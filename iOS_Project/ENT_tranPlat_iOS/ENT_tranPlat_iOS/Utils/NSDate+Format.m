...
- (NSString *)formatString:(DateFormat)format
{
    ...
    switch (format) {
        ...
        case DateFormatWithTime:
            ...
            break;
        case DateFormatWithPreciseHour:
            formatString = @"HH";
            break;
        case DateFormatWithPreciseMin:
            formatString = @"mm";
            break;
        ...
        case DateFormatWithYearMonthDayOther:
            ...
            break;
        case DateFormatWithMonthDayMinte:
            formatString = @"MM月    dd日    HH时    mm分";
            break;
        case DateFormatWithMonthWithDay:
            formatString = @"MM月    dd日";
            break;
        case DateFormatWithHourWithMinte:
            formatString = @"HH时    mm分";
            break;
        case DateFormatWithMonthDayWithMinte:
        ...
        case DateFormatWithMonthDay:
            formatString = @"MM-dd";
            break;
        case DateFormatWithMonthDayAndMinte:
