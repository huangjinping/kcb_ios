...
@interface DriverBindViewController ()
{
...
- (void)loadView_
{
    ...
    _xmTF = [UITextField mainTextFieldWithFrame:YYRectMake(label.r + 30, label.t, _bgView0.w - label.r - 30, 40) placeholder:@"您的姓名" tag:0 delegate:self];
    ...
    label.size = size;
    [_bgView0 addSubview:label];
    _sfzhmTF = [UITextField mainTextFieldWithFrame:YYRectMake(label.r + 30, label.t, _bgView0.w - label.r - 30, 40) placeholder:@"身份证号码" tag:0 delegate:self];
    ...
    _dabhTF = [UITextField mainTextFieldWithFrame:YYRectMake(label.r + 30, label.t, _bgView1.w - label.r - 35 - 30 - 50, 40) placeholder:@"驾照档案编号" tag:0 delegate:self];
    [_bgView1 addSubview:_dabhTF];
    
    UIButton *iButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [iButton setFrame:YYRectMake(_dabhTF.r + 5, _dabhTF.t, 40, 40)];
    ...
    _zxbhTF = [UITextField mainTextFieldWithFrame:YYRectMake(label.r + 30, label.t, _bgView2.w - label.r - 35 - 30 - 50, 40) placeholder:@"新版驾照请填写" tag:0 delegate:self];
    ...
    UILabel *tishiL = [[UILabel alloc] initWithFrame:YYRectMake(baomiImgView.l, noticeLabel.b + 30, 400, 24)];
    ...
    tishiL = [[UILabel alloc] initWithFrame:YYRectMake(tishiL.l, tishiL.b + 20, APP_PX_WIDTH - tishiL.l - 30, 24)];
    [tishiL convertNewLabelWithFont:FONT_NOTICE textColor:COLOR_FONT_NOTICE textAlignment:NSTextAlignmentLeft];
