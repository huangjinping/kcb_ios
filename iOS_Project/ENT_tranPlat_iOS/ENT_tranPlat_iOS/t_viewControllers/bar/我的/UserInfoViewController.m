...
- (void)loadView_
{
    ...
    UILabel *lable = [[UILabel alloc] initWithFrame:YYRectMake(30, (firstLineHeight - 30)/2, 200, 30)];
    ...
    _userPhotoImgView = [[UIImageView alloc] initWithFrame:YYRectMake(bgImgView.w - 30*3 - 80, (firstLineHeight - 80)/2, 80, 80)];
    [bgImgView addSubview:_userPhotoImgView];
    
    lable = [[UILabel alloc] initWithFrame:YYRectMake(30, firstLineHeight + 30, 200, 30)];
    [lable convertNewLabelWithFont:FONT_NOMAL textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentLeft];
    lable.text = @"用户名";
    [bgImgView addSubview:lable];
    _userNameL = [[UILabel alloc] initWithFrame:YYRectMake(bgImgView.w - 30*3 - 400, lable.t, 400, 30)];
    ...
    lable = [[UILabel alloc] initWithFrame:YYRectMake(30, firstLineHeight + sigleLineHeight + 30, 200, 30)];
    [lable convertNewLabelWithFont:FONT_NOMAL textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentLeft];
    lable.text = @"真实姓名";
    [bgImgView addSubview:lable];
    _realNameL = [[UILabel alloc] initWithFrame:YYRectMake(bgImgView.w - 30*3 - 400, lable.t, 400, 30)];
    ...
    lable = [[UILabel alloc] initWithFrame:YYRectMake(30, firstLineHeight + sigleLineHeight*2 + 30, 200, 30)];
    [lable convertNewLabelWithFont:FONT_NOMAL textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentLeft];
    lable.text = @"通讯地址";
    [bgImgView addSubview:lable];
    _addrL = [[UILabel alloc] initWithFrame:YYRectMake(bgImgView.w - 30*3 - 400, lable.t, 400, 30)];
    ...
    [bgImgView addSubview:lineL];
    //******箭头
    UIImageView *arrowImgView = [[UIImageView alloc] initWithFrame:YYRectMake(bgImgView.w - 30 - 30, (firstLineHeight - 30)/2, 30, 30)];
    [arrowImgView setImage:[UIImage imageNamed:@"arrow_right.png"]];
    [bgImgView addSubview:arrowImgView];
//    arrowImgView = [[UIImageView alloc] initWithFrame:YYRectMake(bgImgView.w - 30 - 30, firstLineHeight + 30, 30, 30)];
//    [arrowImgView setImage:[UIImage imageNamed:@"arrow_right.png"]];
//    [bgImgView addSubview:arrowImgView];
    arrowImgView = [[UIImageView alloc] initWithFrame:YYRectMake(bgImgView.w - 30 - 30, firstLineHeight + sigleLineHeight + 30, 30, 30)];
    [arrowImgView setImage:[UIImage imageNamed:@"arrow_right.png"]];
    [bgImgView addSubview:arrowImgView];
    arrowImgView = [[UIImageView alloc] initWithFrame:YYRectMake(bgImgView.w - 30 - 30, firstLineHeight + sigleLineHeight*2 + 30, 30, 30)];
    [arrowImgView setImage:[UIImage imageNamed:@"arrow_right.png"]];
    [bgImgView addSubview:arrowImgView];
    //******action
    UIButton *btn = [UIButton buttonWithType:UIButtonTypeCustom];
    [btn setFrame:YYRectMake(0, 0, bgImgView.w, firstLineHeight)];
    ...
    [btn setFrame:YYRectMake(0, firstLineHeight, bgImgView.w, sigleLineHeight)];
    [btn addTarget:self action:@selector(buttonClicked:) forControlEvents:UIControlEventTouchUpInside];
    ...
    btn = [UIButton buttonWithType:UIButtonTypeCustom];
    [btn setFrame:YYRectMake(0, firstLineHeight + sigleLineHeight, bgImgView.w, sigleLineHeight)];
    [btn addTarget:self action:@selector(buttonClicked:) forControlEvents:UIControlEventTouchUpInside];
    ...
    btn = [UIButton buttonWithType:UIButtonTypeCustom];
    [btn setFrame:YYRectMake(0, firstLineHeight + sigleLineHeight*2, bgImgView.w, sigleLineHeight)];
    [btn addTarget:self action:@selector(buttonClicked:) forControlEvents:UIControlEventTouchUpInside];
    ...
    lable = [[UILabel alloc] initWithFrame:YYRectMake(30, 30, 200, 30)];
    [lable convertNewLabelWithFont:FONT_NOMAL textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentLeft];
    lable.text = @"手机号码";
    [bgImgView addSubview:lable];
    _userTelL = [[UILabel alloc] initWithFrame:YYRectMake(bgImgView.w - 30*3 - 400, lable.t, 400, 30)];
    ...
    lable = [[UILabel alloc] initWithFrame:YYRectMake(30, sigleLineHeight + 30, 200, 30)];
    [lable convertNewLabelWithFont:FONT_NOMAL textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentLeft];
    lable.text = @"电子邮箱";
    [bgImgView addSubview:lable];
    _emailL = [[UILabel alloc] initWithFrame:YYRectMake(bgImgView.w - 30*3 - 400, lable.t, 400, 30)];
    ...
    //*****箭头
    arrowImgView = [[UIImageView alloc] initWithFrame:YYRectMake(bgImgView.w - 30 - 30, 30, 30, 30)];
    [arrowImgView setImage:[UIImage imageNamed:@"arrow_right.png"]];
    [bgImgView addSubview:arrowImgView];
    arrowImgView = [[UIImageView alloc] initWithFrame:YYRectMake(bgImgView.w - 30 - 30, sigleLineHeight + 30, 30, 30)];
    [arrowImgView setImage:[UIImage imageNamed:@"arrow_right.png"]];
    [bgImgView addSubview:arrowImgView];
    //******action
    btn = [UIButton buttonWithType:UIButtonTypeCustom];
    [btn setFrame:YYRectMake(0, 0, bgImgView.w, sigleLineHeight)];
    [btn addTarget:self action:@selector(buttonClicked:) forControlEvents:UIControlEventTouchUpInside];
    [btn setTag:TAG_BUTTON_USER_TEL];
    [btn setBackgroundColor:[UIColor clearColor]];
    [bgImgView addSubview:btn];
    btn = [UIButton buttonWithType:UIButtonTypeCustom];
    [btn setFrame:YYRectMake(0, sigleLineHeight, bgImgView.w, sigleLineHeight)];
    [btn addTarget:self action:@selector(buttonClicked:) forControlEvents:UIControlEventTouchUpInside];
