...
- (void)viewDidLoad
{
  ...
  CGFloat y = 0;
...
#endif
    UIImageView *logoImgView = [[UIImageView alloc] initWithFrame:YYRectMake((APP_PX_WIDTH - 315)/2, APP_VIEW_Y/PX_X_SCALE + 60, 315, 128)];
    [logoImgView setImage:[UIImage imageNamed:@"login_logo.png"]];
    [self.view addSubview:logoImgView];
    
    UIImageView *textfBgImgView = [[UIImageView alloc] initWithFrame:YYRectMake(30, logoImgView.b + 40, 580, 180)];
    ...
    _userNameTF = [UITextField mainTextFieldWithFrame:YYRectMake(130, FIRST_PAGE_TF_SPACE, textfBgImgView.w - 100 - 30, FIRST_PAGE_TF_HEIGHT) placeholder:@"用户名或手机号" tag:0 delegate:self];
    [textfBgImgView addSubview:_userNameTF];
    
    _passwordTF = [UITextField mainTextFieldWithFrame:YYRectMake(_userNameTF.l, FIRST_PAGE_TF_SPACE + 90, _userNameTF.w, _userNameTF.h) placeholder:@"登录密码" tag:0 delegate:self];
    ...
    [forgotPasswordButton setFrame:YYRectMake((APP_PX_WIDTH - s.width/PX_X_SCALE)/2, loginButton.b + 40, s.width/PX_X_SCALE, 24)];
    ...
    [registButton setFrame:YYRectMake((APP_PX_WIDTH - s.width/PX_X_SCALE)/2, forgotPasswordButton.b + 60, s.width/PX_X_SCALE, 30)];
