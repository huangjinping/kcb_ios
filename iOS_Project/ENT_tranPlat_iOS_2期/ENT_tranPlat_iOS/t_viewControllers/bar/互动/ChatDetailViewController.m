...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.userNameLable.frame = CGRectMake(70, 10, 150, 20);
    ...
    cell.blogsContentsLable.frame = CGRectMake(5, 60, 290*bi, size.height);
    ...
    if ([blog.blogcontent.content length] > 150) {
        if ([blog.blogcontent.imgurl length] != 0) {
            ...
            cell.modelLable.frame = CGRectMake(20, cell.blogsImage1.bottom, modelWidth, 25);
            cell.modleImage.frame = CGRectMake(5, cell.blogsImage1.bottom+5, 15, 15);
            cell.cityLable.frame = CGRectMake(modelWidth+20, cell.blogsImage1.bottom, 50, 25);
        }
        else{
            cell.modelLable.frame = CGRectMake(20, cell.blogsContentsLable.bottom+20, modelWidth, 25);
            cell.modleImage.frame = CGRectMake(5, cell.blogsContentsLable.bottom+25, 15, 15);
        ...
        if ([blog.blogcontent.imgurl length] != 0) {
            ...
            cell.modelLable.frame = CGRectMake(20, cell.blogsContentsLable.bottom, modelWidth, 25);
            cell.modleImage.frame = CGRectMake(5, cell.blogsContentsLable.bottom+5, 15, 15);
    ...
    cell.zanCountLable.frame = CGRectMake(20, cell.bgView.bottom+5.5, APP_WIDTH-40, _zanLableHeight);
    cell.zanCountImage.frame = CGRectMake(5, cell.bgView.bottom+5.5+(_zanLableHeight-13)/2, 13, 13);
...
-(void)inputBar:(YFInputBar *)inputBar  withInputString:(NSString *)str
{
    ...
    NSLog(@"float = %f",self.view.frame.size.height);
...
- (void)netZanByUsername:(NSString*)username andBlogId:(NSString*)blogId{
    ...
    [[ChatNetwork sharedChatNetwork] chatPostBody:bodyDict onUrl:@"complimentBlog.do" withPostMethod:@"POST" isResponseJson:YES doShowIndicator:NO onView:self.view callBackWithObj:nil onCompletion:^(PostResult result, id requestObj, NSObject *callBackObj) {
        ...
        if (result == postSucc) {
            ...
            APP_DELEGATE.shouldRefreshBlogList = YES;
