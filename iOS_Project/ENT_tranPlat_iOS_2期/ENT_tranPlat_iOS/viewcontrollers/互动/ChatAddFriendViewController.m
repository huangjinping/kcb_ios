...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (cell == nil) {
        ...
        [cell.actionButton setFrame:CGRectMake(cell.width - cell.actionButton.width, cell.actionButton.top, cell.actionButton.width, cell.actionButton.height)];
...
- (void)loadView_{
    ...
    UIImageView *headBgImgView = [[UIImageView alloc] initWithFrame:CGRectMake(APP_X + 10, APP_VIEW_Y + 10, APP_WIDTH - 20, 40)];
    ...
    UIImageView *rootTabelViewBgImgView = [[UIImageView alloc] initWithFrame:CGRectMake(APP_X + 10, headBgImgView.bottom + space, APP_WIDTH - 20, APP_HEIGHT - APP_NAV_HEIGHT - (headBgImgView.height) - space*3)];
