...
- (void)initDDLog
{
    ...
    [[DDTTYLogger sharedInstance] setForegroundColor:[UIColor blueColor] backgroundColor:[UIColor redColor] forFlag:DDLogFlagInfo];// 可以修改你想要的颜色
    [[DDTTYLogger sharedInstance] setForegroundColor:[UIColor purpleColor] backgroundColor:[UIColor yellowColor] forFlag:DDLogFlagDebug];
        DDLogError(@"错误信息"); // 红色
        DDLogWarn(@"警告"); // 橙色
        DDLogInfo(@"提示信息"); // 蓝色
        DDLogDebug(@"调试信息"); //紫色
