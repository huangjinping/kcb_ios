...
@property(nonatomic,strong)NSString *line;             //车系
@property(nonatomic,strong)NSString *detailDes;        //车详细描述
@property(nonatomic,strong)NSString *carId;            //车型ID
@property(nonatomic,strong)NSString *nk;               //年款
@property(nonatomic,strong)NSString *pql;              //排气量
@property(nonatomic,strong)NSString *icon;             //标志
@property(nonatomic,strong)NSString *seriesId;         //车系ID（请求排量用）
@property(nonatomic,strong)NSString *xslc;             //行驶里程
@property(nonatomic,strong)NSString *xslsj;            //新上路时间
