...
- (void)viewDidLoad {
    ...
    UILabel *topL = [[UILabel alloc] initWithFrame:YYRectMake(30, APP_VIEW_Y/PX_X_SCALE + 30, APP_PX_WIDTH - 30*2, 30)];
    ...
    for (int i = 0; i < _hphms.count; i ++) {
        ...
        UILabel *leftLabel = [[UILabel alloc] initWithFrame:YYRectMake(30, singleLineHeight*i + 30, 200, 30)];
        ...
        UIImageView *imgV = [[UIImageView alloc] initWithFrame:YYRectMake(APP_PX_WIDTH - 30 - 30, leftLabel.t, 30, 30)];
        ...
        [btn setFrame:YYRectMake(30, singleLineHeight*i, APP_PX_WIDTH, singleLineHeight)];
    ...
    topL = [[UILabel alloc] initWithFrame:YYRectMake(30, _carBgImgView.b + 30, APP_PX_WIDTH - 30*2, 30)];
    [topL convertNewLabelWithFont:FONT_NOTICE textColor:COLOR_FONT_NOTICE textAlignment:NSTextAlignmentLeft];
    topL.text = @"筛选时间";
    [self.view addSubview:topL];
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [doneButton setFrame:YYRectMake(_navigationImgView.w - 100, (_navigationImgView.h - 30)/2, 60, 30)];
