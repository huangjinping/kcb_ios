...
- (void)viewDidLoad {
    ...
    //新号码
    _newTelTF = [UITextField mainTextFieldWithFrame:YYRectMake(30, 30, APP_PX_WIDTH - 30*3, 40) placeholder:@"新手机号码" tag:0 delegate:self];
    ...
    _yanzhengmaTF = [UITextField mainTextFieldWithFrame:YYRectMake(30, singleLineHeight + 30, 300, 40) placeholder:@"请输入验证码" tag:0 delegate:self];
    ...
    [_yanzhengButton setFrame:YYRectMake(bgImgView.w - 30 - 250, singleLineHeight + 15, 250, singleLineHeight - 15*2)];
