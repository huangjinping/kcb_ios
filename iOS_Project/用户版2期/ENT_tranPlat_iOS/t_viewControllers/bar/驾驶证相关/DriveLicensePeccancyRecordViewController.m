...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [cell.payButton setFrame:CGRectMake((APP_WIDTH - cell.payButton.width)/2, buttonY, cell.payButton.width, BUTTON_HEIGHT)];
    CGFloat buttonWidth = 130;
    CGFloat buttonSpace = (APP_WIDTH - buttonWidth*2)/3;
