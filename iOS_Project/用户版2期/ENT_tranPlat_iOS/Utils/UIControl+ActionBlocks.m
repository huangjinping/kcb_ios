...
- (void)addActionBlock:(UIControlActionBlock)actionBlock forControlEvents:(UIControlEvents)controlEvents
{
    ...
    blockActionWrapper.flag = self.tag;
...
- (void)removeActionBlocksForControlEvents:(UIControlEvents)controlEvents
{
    ...
    [actionBlocksArray enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
                           ...
                           if (wrapperTmp.controlEvents == controlEvents && wrapperTmp.flag == self.tag) {
