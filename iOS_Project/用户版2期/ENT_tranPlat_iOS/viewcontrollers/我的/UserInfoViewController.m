...
- (void)loadView_
{
    ...
    [lable convertNewLabelWithFont:V3_38PX_FONT textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentLeft];
    lable.text = @"头像";
    ...
    [_userNameL convertNewLabelWithFont:V3_38PX_FONT textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentRight];
    ...
    [_realNameL convertNewLabelWithFont:V3_38PX_FONT textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentRight];
    ...
    [_addrL convertNewLabelWithFont:V3_38PX_FONT textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentRight];
...
//    [bgImgView addSubview:arrowImgView];
    ...
    [_userTelL convertNewLabelWithFont:V3_38PX_FONT textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentRight];
    ...
    [_emailL convertNewLabelWithFont:V3_38PX_FONT textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentRight];
