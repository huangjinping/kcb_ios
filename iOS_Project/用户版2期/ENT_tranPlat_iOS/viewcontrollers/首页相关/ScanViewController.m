...
- (void)viewDidLoad {
    ...
    self.analysising = NO;
    self.done = NO; 
    self.view.backgroundColor = [UIColor colorWithHex:0x000000 alpha:.8f];
...
//    _previewLayer.frame = LGRectMake(0, 350, self.view.w, 100);
...
//    ZKButton *XCButton =[ZKButton blockButtonWithFrame:BBRectMake(1000, 500, 400, 100) type:UIButtonTypeCustom title:@"手动输入决定书编号" backgroundImage:@"" andBlock:^(ZKButton *button) {
//        
//    }];
//    [self.view addSubview:XCButton];
    ZKButton* XCButton=[ZKButton blockButtonWithFrame:BBRectMake(400,1500,600 , 150)  type:UIButtonTypeSystem title:@"手动输入" backgroundImage:nil andBlock:^(ZKButton *button) {
        
        
        
        JDSBHSearchPayViewController *bxpciVC = [[JDSBHSearchPayViewController alloc] init];
    ...
    XCButton.backgroundColor=[UIColor whiteColor];
    ...
    dispatch_async(sessionQueue, ^{
        ...
        //[_output setRectOfInterest:CGRectMake(184, 9, 219, 219)];
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer fromConnection:(AVCaptureConnection *)connection{
    ...
    //UIImage *smallImage = [self getImageByCuttingImage:image Rect:CGRectMake(0, 350*PX_Y_SCALE*bili, image.size.width, 100*PX_Y_SCALE*bili)];
