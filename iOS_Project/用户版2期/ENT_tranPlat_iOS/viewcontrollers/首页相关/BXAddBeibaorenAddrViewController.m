//
//  BXAddBeibaorenAddrViewController.m
//  ENT_tranPlat_iOS
//
...
@interface BXAddBeibaorenAddrViewController ()<
UITextFieldDelegate
>
{
    UILabel     *_cityL;
...
@implementation BXAddBeibaorenAddrViewController
- (void)loadView_{
    ...
    UIImageView *bgImgView = [UIImageView backgroudTwoLineImageViewWithPXX:0 y:30 width:APP_PX_WIDTH height:singleLineHeightPX];
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [self setCustomNavigationTitle:@"被保人身份证地址"];
