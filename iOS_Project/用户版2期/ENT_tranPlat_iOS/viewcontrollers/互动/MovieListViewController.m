...
- (void)loadTable{
    ...
    _movieTable = [[UITableView alloc]initWithFrame:CGRectMake(APP_X, APP_VIEW_Y, APP_WIDTH, APP_HEIGHT - APP_NAV_HEIGHT) style:UITableViewStylePlain];
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [self setCustomNavigationTitle:@"视频教程"];
