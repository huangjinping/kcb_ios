...
- (void)viewDidLoad
{
    ...
    _scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(APP_X, 0, APP_WIDTH, APP_HEIGHT)];
    _scrollView.showsHorizontalScrollIndicator = NO;
    _scrollView.showsVerticalScrollIndicator=NO;
    _scrollView.pagingEnabled = YES;
    [_scrollView setDelegate:self];
    [_scrollView setBackgroundColor:[UIHelper getColor:@"#43b853"]];

    [_scrollView setBounces:NO];
    [self.view addSubview:_scrollView];
    [_scrollView setContentSize:CGSizeMake(APP_WIDTH * _pageCount, APP_HEIGHT - 20)];
