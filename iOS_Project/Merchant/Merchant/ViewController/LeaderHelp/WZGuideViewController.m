...
- (void)viewDidLoad
{
    ...
    NSArray *imageNameArray = [NSArray arrayWithObjects:@"interface1_6p.jpg", @"interface2_6p.jpg", @"interface3_6p.jpg",nil];
    
    
    _pageScroll = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, APP_WIDTH, APP_HEIGHT)];
