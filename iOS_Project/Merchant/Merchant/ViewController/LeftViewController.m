...
- (void)viewDidAppear:(BOOL)animated{
    ...
    NSString * url = ApplicationDelegate.shareLoginData.userdata.logo;
    NSLog(@"头像当前的图片地址:%@",url);
    [storeIcon sd_setImageWithURL:[NSURL URLWithString:url] placeholderImage:[UIImage imageNamed:@"shopDefault_small"] options:SDWebImageRefreshCached];
...
- (void)buildUI{
    ...
    storeIcon = [[UIImageView alloc] initWithFrame:CGRectMake(10, 10, 80, 80)];
    storeIcon.contentMode = UIViewContentModeScaleToFill;
    [view addSubview:storeIcon];
    
    storeName= [[UILabel alloc] initWithFrame:CGRectMake(storeIcon.right+10, 0, APP_WIDTH-storeIcon.right-120, 60)];
