...
//  Copyright (c) 2015年 bbtree. All rights reserved.
//

#import "YZKSelectTableView.h"
#define kSelectTableViewMargin 15
...
- (instancetype)initWithTitle:(NSString *)title
                    dataArray:(NSArray *)dataArray
                     delegate:(id<YZKSelectTableViewDelegate>)delegate selectedIndex:(NSInteger)index
{
    self = [super init];
...
- (void)createView
{
    ...
    _popView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width - 40, 308)];
    _popView.backgroundColor = [UIColor whiteColor];
    [self addSubview:_popView];

    _titleView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, _popView.frame.size.width, 0)];
    _titleView.backgroundColor = [UIColor colorWithHex:0x599cc9];
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(kSelectTableViewMargin, CGRectGetMaxY(_titleView.frame), _popView.frame.size.width - 2*kSelectTableViewMargin, _popView.frame.size.height - CGRectGetMaxY(_titleView.frame))];
...
//        cell.accessoryView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"checkBox_selected"]];
//    }else{
//        cell.accessoryType = UITableViewCellAccessoryNone;
//        cell.accessoryView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"checkBox_unSelected"]];
//    }
