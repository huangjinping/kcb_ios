...
- (void)setupLabels {
    ...
    CGSize ssize = [self.detailsLabelText sizeWithFont:detailsLabel.font constrainedToSize:CGSizeMake(detailsLabel.frame.size.width, 1000)];
    [detailsLabel setFrame:CGRectMake(detailsLabel.frame.origin.x, detailsLabel.frame.origin.y, ssize.width, ssize.height)];
