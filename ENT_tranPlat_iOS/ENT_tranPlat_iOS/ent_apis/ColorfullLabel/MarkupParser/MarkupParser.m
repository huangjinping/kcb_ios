...
-(NSAttributedString *)attrStringFromMarkup:(NSString *)markup withFontSize:(CGFloat)size andLineSpace:(CGFloat)lineSpace
{
    ...
    for (NSTextCheckingResult *b in chunks) {
        ...
        CTFontRef fontRef = CTFontCreateWithName((CFStringRef)self.font, size, NULL);
        ...
        [(NSMutableAttributedString*)aString addAttribute:NSParagraphStyleAttributeName value:paragraphStyle range:NSMakeRange(0, [aString length])];
