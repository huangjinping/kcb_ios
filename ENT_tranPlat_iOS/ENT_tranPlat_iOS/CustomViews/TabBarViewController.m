...
- (void)_initTabBar
{
    ...
    _tabBarView.backgroundColor = [UIHelper getColor:@"#e7e7e7"];
    ...
    float itemHeight = 74/2;//*PX_X_SCALE;
    float itemWidth = 60/2;//*PX_X_SCALE;//APP_WIDTH/titles.count;
    ...
    UIButton *barLogoButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [barLogoButton setFrame:frame];
    [barLogoButton setImage:[UIImage imageNamed:@"tb_home_selected"] forState:UIControlStateNormal];
    ...
    barLogoButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [barLogoButton setFrame:frame];
    [barLogoButton setImage:[UIImage imageNamed:@"tb_cheyouquan_unselected"] forState:UIControlStateNormal];
    [barLogoButton addTarget:self action:@selector(barButtonClicked:) forControlEvents:UIControlEventTouchUpInside];
    ...
    barLogoButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [barLogoButton setFrame:frame];
    [barLogoButton setImage:[UIImage imageNamed:@"tb_faxian_unselected"] forState:UIControlStateNormal];
    [barLogoButton addTarget:self action:@selector(barButtonClicked:) forControlEvents:UIControlEventTouchUpInside];
...
//    [_newMsgImgView addSubview:_newMsgCouLabel];
    ...
    barLogoButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [barLogoButton setFrame:frame];
    [barLogoButton setImage:[UIImage imageNamed:@"tb_wode_unselected"] forState:UIControlStateNormal];
    [barLogoButton addTarget:self action:@selector(barButtonClicked:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)viewDidLoad
{
    ...
    NSArray *viewVC = @[homeVC, chatVC, fxVC, userVC];
...
- (void)barButtonClicked:(UIButton*)button{
    ...
    if (button.tag == TAG_BUTTON_SHOUYE) {
        [button setImage:[UIImage imageNamed:@"tb_home_selected"] forState:UIControlStateNormal];
    }else if (button.tag == TAG_BUTTON_HUDONG) {
        [button setImage:[UIImage imageNamed:@"tb_cheyouquan_selected"] forState:UIControlStateNormal];
    }
    else if (button.tag == TAG_BUTTON_FAXIAN) {
        [button setImage:[UIImage imageNamed:@"tb_faxian_selected"] forState:UIControlStateNormal];
        
        }
    else if (button.tag == TAG_BUTTON_MINE) {
        [button setImage:[UIImage imageNamed:@"tb_wode_selected"] forState:UIControlStateNormal];
    }
        ...
        if ([obj isKindOfClass:[UIButton class]]) {
            ...
            if (button.tag == _lastSelectedIndex) {
                switch (button.tag - TAG_BUTTON_BASIC) {
                    case 0:
                        [button setImage:[UIImage imageNamed:@"tb_home_unselected"] forState:UIControlStateNormal];
                        break;
                    case 1:
                        [button setImage:[UIImage imageNamed:@"tb_cheyouquan_unselected"] forState:UIControlStateNormal];
                        break;
                    case 2:
                        [button setImage:[UIImage imageNamed:@"tb_faxian_unselected"] forState:UIControlStateNormal];
                        break;
                    case 3:
                        [button setImage:[UIImage imageNamed:@"tb_wode_unselected"] forState:UIControlStateNormal];
                        break;
                    default:
                        break;
                }
