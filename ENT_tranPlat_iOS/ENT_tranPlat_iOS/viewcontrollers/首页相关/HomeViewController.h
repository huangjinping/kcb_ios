...
#define CAR_VIEW_INFO_HEIGHT     (30 + 30 + 140)
#define CAR_VIEW_PECCANCY_HEIGHT     (20 + 30 + 20 + 30 + 20)
#define CAR_VIEW_NOTICE_HEIGHT     (30)
#define CAR_INFO_SCROLL_VIEW_PAGE_HEIGHT     (20)

#define CAR_VIEW_NOTICE_HEIGHT_SPACE     (15 + 15)

#define CAR_INFO_SCROLL_VIEW_HEIGHT     (CAR_VIEW_INFO_HEIGHT + CAR_VIEW_PECCANCY_HEIGHT + CAR_VIEW_NOTICE_HEIGHT + CAR_INFO_SCROLL_VIEW_PAGE_HEIGHT + CAR_VIEW_NOTICE_HEIGHT_SPACE)
