...
>
{
    ...
    UIImageView         *_searchButtonBgView;
...
- (void)loadView_{
    ...
    UIImageView *searchBgImgView = [[UIImageView alloc] initWithFrame:LGRectMake(0, 0, APP_PX_WIDTH, 30*3)];
    [searchBgImgView setBackgroundColor:COLOR_FRAME_LINE];
    [searchBgImgView setUserInteractionEnabled:YES];
    [_rootScrollView addSubview:searchBgImgView];
    
    
    _searchButtonBgView = [[UIImageView alloc] initWithFrame:LGRectMake(APP_PX_WIDTH - 30 - 40, (90 - 40)/2, 40, 40)];
    [_searchButtonBgView setImage:[UIImage imageNamed:@"btn_search.png"]];
    [searchBgImgView addSubview:_searchButtonBgView];
    
    _searchButton = [[UIButton alloc] initWithFrame:LGRectMake(APP_PX_WIDTH - searchBgImgView.h, 0, searchBgImgView.h, searchBgImgView.h)];
    [_searchButton setBackgroundColor:[UIColor clearColor]];
    [_searchButton addTarget:self action:@selector(startSearch:) forControlEvents:UIControlEventTouchUpInside];
    _searchButton.userInteractionEnabled = NO;
    [searchBgImgView addSubview:_searchButton];
                                                                             
    UIImageView *imgView = [[UIImageView alloc] initWithFrame:LGRectMake(30, 20, APP_PX_WIDTH - 30*2 - 40 - 20, 50)];
    ...
    _JDSBHTextField.placeholder = @"请输入16位的决定书编号";
    [imgView addSubview:_JDSBHTextField];
    if (self.jdsbh) {
        _JDSBHTextField.text = self.jdsbh;
    }
    
    UILabel *l = [[UILabel alloc] initWithFrame:LGRectMake(30, searchBgImgView.b + 20, APP_PX_WIDTH - 30*2, 60)];
    l.numberOfLines = 0;
    ...
    _contentBgView = [[UIView alloc] initWithFrame:LGRectMake(0, l.b + 20, APP_PX_WIDTH, 0)];
...
- (void)reloadView{
    ...
    UILabel *label = [[UILabel alloc] initWithFrame:LGRectMake(30, 30, 0, 30)];
    ...
    UILabel *hphmL = [[UILabel alloc] initWithFrame:LGRectMake(label.r + 15, label.t, 400, size.height/PX_X_SCALE)];
    ...
    label = [[UILabel alloc] initWithFrame:LGRectMake(30, label.b + 20, size.width/PX_X_SCALE, size.height/PX_X_SCALE)];
    [label convertNewLabelWithFont:FONT_NOMAL textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentLeft];
    label.text = @"违法时间：";
    [_contentBgView addSubview:label];
    UILabel *timeL = [[UILabel alloc] initWithFrame:LGRectMake(label.r + 15, label.t, APP_PX_WIDTH - label.r - 15 - 30, size.height/PX_X_SCALE)];
    ...
    label.text = @"当事人：";
    [_contentBgView addSubview:label];
    UILabel *dsrL = [[UILabel alloc] initWithFrame:LGRectMake(label.r + 15, label.t, APP_PX_WIDTH - label.r - 15 - 30, size.height/PX_X_SCALE)];
    ...
    label.text = @"违法地点：";
    [_contentBgView addSubview:label];
    UILabel *wfddL = [[UILabel alloc] initWithFrame:LGRectMake(label.r + 15, label.t, APP_PX_WIDTH - label.r - 15 - 30, size.height/PX_X_SCALE)];
    ...
    label = [[UILabel alloc] initWithFrame:LGRectMake(30, wfddL.b + 20, size.width/PX_X_SCALE, size.height/PX_X_SCALE)];
    [label convertNewLabelWithFont:FONT_NOMAL textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentLeft];
    label.text = @"发现机关：";
    [_contentBgView addSubview:label];
    UILabel *fxjgL = [[UILabel alloc] initWithFrame:LGRectMake(label.r + 15, label.t, APP_PX_WIDTH - label.r - 15 - 30, size.height/PX_X_SCALE)];
    ...
    label = [[UILabel alloc] initWithFrame:LGRectMake(30, fxjgL.b + 20, size.width/PX_X_SCALE, size.height/PX_X_SCALE)];
    [label convertNewLabelWithFont:FONT_NOMAL textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentLeft];
    label.text = @"违法行为：";
    [_contentBgView addSubview:label];
    UILabel *wfxwL = [[UILabel alloc] initWithFrame:LGRectMake(label.r + 15, label.t, APP_PX_WIDTH - label.r - 15 - 30, size.height/PX_X_SCALE)];
    ...
    label = [[UILabel alloc] initWithFrame:LGRectMake(30, wfxwL.b + 20, size.width/PX_X_SCALE, size.height/PX_X_SCALE)];
    [label convertNewLabelWithFont:FONT_NOMAL textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentLeft];
    label.text = @"违法内容：";
    [_contentBgView addSubview:label];
    UILabel *wfnrL = [[UILabel alloc] initWithFrame:LGRectMake(label.r + 15, label.t, APP_PX_WIDTH - label.r - 15 - 30, size.height/PX_X_SCALE)];
    ...
    label = [[UILabel alloc] initWithFrame:LGRectMake(30, wfnrL.b + 20, size.width/PX_X_SCALE, size.height/PX_X_SCALE)];
    [label convertNewLabelWithFont:FONT_NOMAL textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentLeft];
    label.text = @"缴纳罚金：";
    [_contentBgView addSubview:label];
    UILabel *jnfjL = [[UILabel alloc] initWithFrame:LGRectMake(label.r + 15, label.t, APP_PX_WIDTH - label.r - 15 - 30, size.height/PX_X_SCALE)];
    ...
    UILabel *l = [[UILabel alloc] initWithFrame:LGRectMake(jnfjL.r + 5, jnfjL.t, 100, jnfjL.h)];
    ...
    label.text = @"滞纳金：";
    [_contentBgView addSubview:label];
    UILabel *znjL = [[UILabel alloc] initWithFrame:LGRectMake(label.r + 15, label.t, APP_PX_WIDTH - label.r - 15 - 30, size.height/PX_X_SCALE)];
    ...
    l = [[UILabel alloc] initWithFrame:LGRectMake(znjL.r + 5, znjL.t, 100, znjL.h)];
    [l convertNewLabelWithFont:FONT_NOMAL textColor:COLOR_FONT_INFO_SHOW textAlignment:NSTextAlignmentLeft];
    l.text = @"元";
    [_contentBgView addSubview:l];
    ...
    label.text = @"缴款状态：";
    [_contentBgView addSubview:label];
    UILabel *jkztL = [[UILabel alloc] initWithFrame:LGRectMake(label.r + 15, label.t, APP_PX_WIDTH - label.r - 15 - 30, size.height/PX_X_SCALE)];
...
- (void)startSearch:(id)sender{
    ...
    if (_JDSBHTextField.text.length > 14) {
        [self getRecordByJDSBH:[_JDSBHTextField.text substringWithRange:NSMakeRange(0, 15)]];
...
#pragma mark- 网络请求
- (void)getRecordByJDSBH:(NSString*)jdsbh{
    NSMutableDictionary *dict = [[NSMutableDictionary alloc] initWithCapacity:0];
    [dict setObject:@"listbyjdsbh" forKey:@"action"];
    [dict setObject:jdsbh forKey:@"jdsbh"];
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string{
    ...
    if (![string isEqualToString:@""]) {
        if (textField.text.length > 13) {
            [_searchButtonBgView setImage:[UIImage imageNamed:@"btn_search_avalible"]];
            _searchButton.userInteractionEnabled = YES;
        }
    }else{
        if (textField.text.length < 16) {
            [_searchButtonBgView setImage:[UIImage imageNamed:@"btn_search"]];
            _searchButton.userInteractionEnabled = NO;
