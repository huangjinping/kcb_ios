...
- (void)viewDidLoad {
    ...
    _addrTF = [UITextField mainTextFieldWithFrame:YYRectMake(label.r + 30, label.t, bgImgView.w - (label.r + 30) - 30, 40) placeholder:@"请填写详细地址" tag:0 delegate:self];
    ...
    [label setSize:size];
    [bgImgView addSubview:label];
    _postCodeTF = [UITextField mainTextFieldWithFrame:YYRectMake(label.r + 30, label.t, bgImgView.w - (label.r + 30) - 30, 40) placeholder:@"请填写邮编" tag:0 delegate:self];
