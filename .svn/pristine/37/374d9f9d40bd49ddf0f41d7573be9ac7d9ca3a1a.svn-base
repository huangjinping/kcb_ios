...
- (void)reloadViews
{
    ...
    [_weifaCountL convertNewLabelWithFont:V3_38PX_FONT textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentRight];
    ...
    _enterWeifaButton.titleLabel.font = V3_38PX_FONT;
    ...
    [contentL convertNewLabelWithFont:V3_38PX_FONT textColor:COLOR_FONT_INFO_SHOW textAlignment:NSTextAlignmentLeft];
