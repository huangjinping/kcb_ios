...
//        [self addObserver:self forKeyPath:@"titlesAndLogos" options:NSKeyValueObservingOptionNew|NSKeyValueObservingOptionOld context:nil];
        ...
        _roottv.separatorColor = [UIColor darkGrayColor];
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (cell == nil) {
        ...
        UIImageView *logoView = [[UIImageView alloc] initWithFrame:CGRectMake(3, 10, 30, 30)];
    ...
    if (indexPath.row == 0) {
        UIImageView *imgLineView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, cell.width, 0.5)];
