...
-(void)creatUI{
    ...
    UIImageView *firstView = [UIImageView backgroudTwoLineImageViewWithPXX:0 y: 0 width:APP_PX_WIDTH height:singleLineHeightPX*7-20];
    ...
    UIImageView *founView=[UIImageView backgroudTwoLineImageViewWithPXX:0 y: secondView.h+firstView.h + 40 width:APP_PX_WIDTH height:contentLineHeight*1+20];
    ...
    if ([[_model valueForKey:@"status"]isEqualToString:@"3"]){
        ...
        // CGFloat height = 90;
        CGFloat contentLineHeight = 70;
        UIImageView *buttonBgView =[UIImageView backgroudTwoLineImageViewWithPXX:0 y: founView.h+ firstView.h + secondView.h + 3*20 width:APP_PX_WIDTH height:contentLineHeight*1.5];
