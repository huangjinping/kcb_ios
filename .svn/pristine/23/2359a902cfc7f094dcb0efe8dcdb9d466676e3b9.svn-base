...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        _outNameLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 600*x_6_plus, 48*y_6_plus)
                                                 text:@"" font:V3_38PX_FONT
                                            textColor:kTextBlackColor];
        _serviceTypeBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        
        _detailLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 110*x_6_SCALE, 38*y_6_plus)
        ...
        _cancleBtn.backgroundColor = kTextOrangeColor;
...
- (void)layoutSubviews{
    ...
    _serviceTypeBtn.origin = CGPointMake(_outNameLabel.x, _outNameLabel.bottom+45*y_6_plus);
    _detailLabel.origin = CGPointMake(_outNameLabel.x, _serviceTypeBtn.bottom+20*y_6_plus);
    ...
    _cancleBtn.frame = _refoundLBtn.frame;
    _waitCommentBtn.frame = _confirmDoneBtn.frame;
    _refoundRBtn.frame = _confirmDoneBtn.frame;
    _paidBtn.frame = _confirmDoneBtn.frame;
...
- (void)configCellWithDic:(NSDictionary *)dic{
    ...
    switch ([dic[@"orderType"] integerValue]) {
        case 1:
            ...
            [_serviceTypeBtn setTitle:@"自助保养服务"];
