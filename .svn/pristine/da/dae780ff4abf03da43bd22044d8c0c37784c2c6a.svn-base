...
- (void)reloadNavSegmentButtons{
    if (_navSegmentButtonIndex == 0) {
        _jiaoliuButton.selected=YES;
        _huodongButton.selected=NO;
        _shouceButton.selected=NO;
        [UIView animateWithDuration:.2f animations:^{
            _line.x = _jiaoliuButton.x;
        }];
...
//        [_shouceButton setBackgroundImage:[UIImage imageNamed:@"chat_nav_btn_right_unselected"] forState:UIControlStateNormal];
        _jiaoliuButton.selected=NO;
        _huodongButton.selected=YES;
        _shouceButton.selected=NO;
        [UIView animateWithDuration:.2f animations:^{
            _line.x = _huodongButton.x;
        }];
    }else if (_navSegmentButtonIndex == 2) {
        _jiaoliuButton.selected=NO;
        _huodongButton.selected=NO;
        _shouceButton.selected=YES;
        [UIView animateWithDuration:.2f animations:^{
            _line.x = _shouceButton.x;
        }];
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [_jiaoliuButton setTitle:@"交流"];
    [_jiaoliuButton setTitleColor:[UIColor colorWithRed:192/255 green:227/255 blue:197/255 alpha:.5] forState:UIControlStateNormal];
     [_jiaoliuButton setTitleColor:kWhiteColor forState:UIControlStateSelected];
    [_jiaoliuButton.titleLabel setFont:V3_42PX_FONT];
    _jiaoliuButton.tag = TAG_CHAT_BUTTON_JIAOLIU;
    _jiaoliuButton.selected = YES;
    [_jiaoliuButton addTarget:self action:@selector(navButtonClicked:)];
    ...
    [_huodongButton setTitleColor:[UIColor colorWithRed:192/255 green:227/255 blue:197/255 alpha:.5] forState:UIControlStateNormal];
    [_huodongButton.titleLabel setFont:V3_42PX_FONT];
    [_huodongButton setTitleColor:kWhiteColor forState:UIControlStateSelected];
    ...
    [_shouceButton setTitleColor:[UIColor colorWithRed:192/255 green:227/255 blue:197/255 alpha:.5] forState:UIControlStateNormal];
    [_shouceButton setTitle:@"手册" forState:UIControlStateNormal];
    [_shouceButton setTitleColor:kWhiteColor forState:UIControlStateSelected];
    [_shouceButton.titleLabel setFont:V3_42PX_FONT];
    ...
    _line = [[UIView alloc]initWithFrame:CGRectMake(_jiaoliuButton.x, _jiaoliuButton.bottom-10*y_6_plus, _jiaoliuButton.width, 10*y_6_plus)];
    _line.backgroundColor = kWhiteColor;
     [_navigationImgView addSubview:_line];
