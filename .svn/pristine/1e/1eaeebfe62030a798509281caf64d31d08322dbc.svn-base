...
- (void)viewDidLoad {
    ...
    _qicheNameArr = [NSArray arrayWithObjects:@"大型汽车", @"小型汽车", @"使馆汽车", @"领馆汽车", @"境外汽车", @"外籍汽车", @"教练汽车", @"试验汽车", @"临时入境汽车", @"警用汽车", nil];//[_qicheDict allValues];
    ...
    _otherNameArr = [NSArray arrayWithObjects:@"两、三轮摩托车", @"轻便摩托车", @"使馆摩托车", @"领馆摩托车", @"境外摩托车", @"外籍摩托车", @"农用运输车", @"拖拉机", @"挂车", @"教练摩托车", @"试验摩托车", @"临时入境摩托车", @"临时行驶车", @"警用摩托", @"非机动车", nil];//[_otherDict allValues];
