...
- (void)viewDidLoad {
    ...
    _firstView=[[UIView alloc]initWithFrame:CGRectMake(0, 64, APP_WIDTH, APP_HEIGHT/4)];
...
-(void)addimg{
    ...
    for (int i =0; i<4; i++) {
        ...
        UIImageView *LabelImageview=[[UIImageView alloc]initWithFrame:CGRectMake((160+20)*PX_X_SCALE,(300 +i*140)*PX_Y_SCALE, 380*PX_X_SCALE, 30*PX_Y_SCALE)];
