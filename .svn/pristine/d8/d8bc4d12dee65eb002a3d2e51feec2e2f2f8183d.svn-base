...
- (void)viewDidLoad {
    ...
    for (int i = 0; i < 5; i++) {
        ...
        [label convertNewLabelWithFont:V3_32PX_FONT textColor:COLOR_FONT_INFO_SHOW textAlignment:NSTextAlignmentLeft];
        ...
        switch (i) {
            ...
            case 3:
                ...
                break;
            case 4:
                contentStr = [NSString stringWithFormat:@"新车知道价格: %@万",[_dic valueForKey:@"price"] ];
                break;
            default:
                break;
        }
   ...
   UILabel *CLGZz=[[UILabel alloc] initWithFrame:LGRectMake(10, firstView.h-140+20+60 , firstView.w/3-20, 40)];
    [CLGZz convertNewLabelWithFont:V3_38PX_FONT textColor:COLOR_BUTTON_YELLOW textAlignment:NSTextAlignmentLeft];
    ...
    [cssgj convertNewLabelWithFont:V3_38PX_FONT textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentLeft];
    cssgj.text=csstring;
   ...
   UILabel *gr=[[UILabel alloc] initWithFrame:LGRectMake(10+firstView.w/3*2, firstView.h-140+20+60 , firstView.w/3*2-20, 40)];
    ...
    [gr convertNewLabelWithFont:V3_38PX_FONT textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentLeft];
    gr.text=grstring;
