...
NSString *const WATTINGFORPAY = @"WATTINGFORPAY";
NSString *const WATTINGFORSERVICE = @"WATTINGFORSERVICE";
NSString *const WATTINGFORCOMMNET = @"WATTINGFORCOMMNET";
NSString *const WATTINGFORREFOUND = @"WATTINGFORREFOUND";
...
- (void)location{
    ...
    NSLog(@"%@",resourceDict);
    NSString *css= [[NSUserDefaults standardUserDefaults] objectForKey:KEY_CITY_ADCODE_IN_USERDEFAULT];
    NSLog(@"%@",css);
    NSUserDefaults *u = [NSUserDefaults standardUserDefaults];
    if ([u objectForKey:KEY_CITY_NAME_IN_USERDEFAULT] && [u objectForKey:KEY_CITY_ADCODE_IN_USERDEFAULT]) {
        return ;
    }
    [[LocationManager shareLocationManager] getCurrentCitySearchFinishDone:^(NSString *city,NSString *code, CLLocationCoordinate2D coordinate) {
        NSMutableDictionary *dic = [NSMutableDictionary dictionary];
        NSString *CD = [NSString stringWithFormat:@"%lf,%lf",coordinate.longitude,coordinate.latitude];
        [dic setObject:CD forKey:KEY_CLLOCATION_IN_USERDEFAULT];
        [u setObject:dic forKey:KEY_CLLOCATION_IN_USERDEFAULT];
        
        [u synchronize];
        if ([city isLegal] && [code isLegal]) {
            [u setObject:city forKey:KEY_CITY_NAME_IN_USERDEFAULT];
            [u setObject:code forKey:KEY_CITY_ADCODE_IN_USERDEFAULT];
