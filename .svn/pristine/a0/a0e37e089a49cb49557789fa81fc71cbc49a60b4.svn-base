...
//    
    ...
    [_SZDQ convertNewLabelWithFont:FONT_NOMAL textColor:COLOR_LINK textAlignment:NSTextAlignmentLeft];
     [_SZDQ setText:@"请选择地区"];
...
//    //*********************************具体车型*********************************
    ...
    [_JTCX convertNewLabelWithFont:FONT_NOMAL textColor:COLOR_LINK textAlignment:NSTextAlignmentLeft];
    [_JTCX setText:@"请选择车型"];
...
//    //*********************************首次上牌*********************************
    ...
    [_SCSP convertNewLabelWithFont:FONT_NOMAL textColor:COLOR_LINK textAlignment:NSTextAlignmentLeft];
    [_SCSP setText:@"上牌时间"];
