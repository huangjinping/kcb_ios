...
- (void)loadView_
{
    ...
    UILabel *l = [[UILabel alloc] initWithFrame:YYRectMake(30, APP_VIEW_Y/PX_X_SCALE + 20, 200, 30)];
    ...
    _hphmPrefixLabel = [[UILabel alloc] initWithFrame:YYRectMake(label.r + 30, label.t, 0, 30)];
    ...
    UIImageView *rightArrowImgView = [[UIImageView alloc] initWithFrame:YYRectMake(_hphmPrefixLabel.r + 4, _hphmPrefixLabel.t + 7, 24, 24)];
    ...
    [hphmPrefixButton setFrame:YYRectMake(_hphmPrefixLabel.l, _hphmPrefixLabel.t, rightArrowImgView.r - _hphmPrefixLabel.l, _hphmPrefixLabel.h)];
    ...
    _hphmTF = [UITextField mainTextFieldWithFrame:YYRectMake(hphmPrefixButton.r + 15, hphmPrefixButton.t, _mainBgView.w - hphmPrefixButton.r - 15 - 30, 40) placeholder:@"输入车牌号码" tag:0 delegate:self];
    ...
    label.size = size;
    [_mainBgView addSubview:label];
    _sbdhTF = [UITextField mainTextFieldWithFrame:YYRectMake(label.r + 30, label.t, _mainBgView.w - label.r - 35 - 30 - 50, 40) placeholder:@"输入车辆识别代号" tag:0 delegate:self];
    [_mainBgView addSubview:_sbdhTF];
    UIButton *iButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [iButton setFrame:YYRectMake(_sbdhTF.r + 5, _sbdhTF.t, 40, 40)];
    ...
    label.size = size;
    [_mainBgView addSubview:label];
    _carTypeL = [[UILabel alloc] initWithFrame:YYRectMake(label.r + 30, label.t, _mainBgView.w - label.r - 30 - 30 - 30, 30)];
    ...
    rightArrowImgView = [[UIImageView alloc] initWithFrame:YYRectMake(_mainBgView.w - 30 - 30, label.t + 7, 24, 24)];
    [rightArrowImgView setImage:[UIImage imageNamed:@"arrow_right"]];
    [rightArrowImgView setUserInteractionEnabled:YES];
    [_mainBgView addSubview:rightArrowImgView];
    UIButton *carTypeB = [UIButton buttonWithType:UIButtonTypeCustom];
    [carTypeB setBackgroundColor:[UIColor clearColor]];
    [carTypeB setFrame:YYRectMake(_carTypeL.l, _carTypeL.t, rightArrowImgView.r - _carTypeL.l, _carTypeL.h)];
    ...
    _submitBgView = [[UIView alloc] initWithFrame:YYRectMake(0, _mainBgView.b + 30, APP_PX_WIDTH, 90 + 30 + 60)];
    ...
    UIImageView *baomiImgView = [[UIImageView alloc] initWithFrame:YYRectMake(30, submitB.b + 30, 45 , 52)];
    [baomiImgView setImage:[UIImage imageNamed:@"home_secret"]];
    [_submitBgView addSubview:baomiImgView];
    UILabel *noticeLabel = [[UILabel alloc] initWithFrame:YYRectMake(baomiImgView.r + 20, baomiImgView.t, APP_PX_WIDTH - baomiImgView.r - 20 - 30, 60)];
    ...
    label = [[UILabel alloc] initWithFrame:YYRectMake(30, 30, 100, 30)];
    [label convertNewLabelWithFont:FONT_NOMAL textColor:COLOR_FONT_NOMAL textAlignment:NSTextAlignmentLeft];
    label.text = @"车主姓名";
    label.size = size;
    [_chezhuMsgBgView addSubview:label];
    _chezhuNameTF = [UITextField mainTextFieldWithFrame:YYRectMake(label.r + 30, label.t, _chezhuMsgBgView.w - label.r - 35 - 30 - 50, 40) placeholder:@"输入车主姓名" tag:0 delegate:self];
    ...
    label.size = size;
    [_chezhuMsgBgView addSubview:label];
    _chezhuZhengjianTF = [UITextField mainTextFieldWithFrame:YYRectMake(label.r + 30, label.t, _chezhuMsgBgView.w - label.r - 35 - 30 - 50, 40) placeholder:@"输入车主证件号码" tag:0 delegate:self];
...
- (void)hiddenChezhuView:(BOOL)hidden{
    ...
    if (hidden) {
        [_submitBgView setFrame:YYRectMake(_submitBgView.l, _submitBgView.t - (90*2 + 30), _submitBgView.w, _submitBgView.h)];
    }else{
...
- (void)netSubmitToBandcar
{
    ...
    if (self.reBindHphm) {
        ...
        CarInfo *rebindCar = [rebindCars lastObject];
        ...
        [[Network sharedNetwork] postBody:dict isResponseJson:NO doShowIndicator:YES callBackWithObj:nil onCompletion:^(PostResult result, id requestObj, NSObject *callBackObj) {
            if (result == postSucc) {
                ...
                //提示成功
                UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"提示信息" message:@"重新绑定车辆成功" delegate:self cancelButtonTitle:@"确认" otherButtonTitles:nil, nil];
                ...
                UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"提示信息" message:[NSString stringWithFormat:@"重新绑定车辆失败:%@",(NSString*)requestObj] delegate:self cancelButtonTitle:@"确认" otherButtonTitles:nil, nil];
