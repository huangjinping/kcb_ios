...
//向数据库添加一条car信息
- (void)add{
    NSArray *carArr = [[DataBase sharedDataBase] selectCarByUserId:self.userId];
    NSMutableArray *oriArr = [NSMutableArray arrayWithArray:carArr];
    [oriArr addObject:self];
    [[DataBase sharedDataBase] deleteCarInfoByUserId:APP_DELEGATE.userId];
    NSMutableArray *mArr=[[NSMutableArray alloc]init];
    for (CarInfo *car in oriArr) {
