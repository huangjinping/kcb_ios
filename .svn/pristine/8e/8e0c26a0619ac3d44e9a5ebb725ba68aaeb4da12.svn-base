...
//    
//    [[NetworkEngine sharedNetwork] postBody:@{@"action":@"checkuser",@"username":user} apiPath:@"andriod.do" hasHeader:NO finish:^(ResultState state, id resObj) {
...
//
    ...
    [op addCompletionHandler:^(MKNetworkOperation *completedOperation) {
        ...
        NSMutableArray *responseArr = [[responseStr componentsSeparatedByString:@","] mutableCopy];
        if ([responseArr.lastObject isEqual:@""]) {
           [responseArr removeLastObject];
        }
