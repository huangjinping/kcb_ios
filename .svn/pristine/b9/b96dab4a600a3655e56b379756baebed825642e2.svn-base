...
@interface CitySetViewController ()<
...
@implementation CitySetViewController
...
- (void)viewDidLoad
{
    ...
    [_sectionnameCitysDict setObject:[NSArray arrayWithObjects:[NSDictionary dictionaryWithObjectsAndKeys:@"北京", @"name", @"0101", @"code", nil], [NSDictionary dictionaryWithObjectsAndKeys:@"广州", @"name", @"2801", @"code", nil], [NSDictionary dictionaryWithObjectsAndKeys:@"上海", @"name", @"0201", @"code", nil], [NSDictionary dictionaryWithObjectsAndKeys:@"深圳", @"name", @"2806", @"code", nil], [NSDictionary dictionaryWithObjectsAndKeys:@"重庆", @"name", @"0401", @"code", nil], nil] forKey:@"热门城市"];
