...
- (void)viewDidLoad {
    ...
    [_zcrqL convertNewLabelWithFont:V3_38PX_FONT textColor:COLOR_LINK textAlignment:NSTextAlignmentLeft];
    ...
    [_cityL convertNewLabelWithFont:V3_38PX_FONT textColor:COLOR_LINK textAlignment:NSTextAlignmentLeft];
